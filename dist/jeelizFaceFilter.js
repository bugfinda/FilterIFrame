...
var JEEFACEFILTERAPI = (function () {
  window.JEEFACEFILTERAPIGEN = function () {
    function yb() {
      ...
      this.Jd = function (f) {
        ...
        a = f.map(function (l, n) {
          ...
          return (k = n = 0 === n ? Kb.instance(l) : Lb.instance(l));
        });
        c = a[0];
        d = a[e - 1];
    ...
    var Ma, Na, Oa, Wa, Xa, Pa, Ya, Za, $a, ab, ib, jb, kb, lb;
    function mb(a, c) {
      var d = c % 8;
    ...
    function Mb(a) {
      ...
      for (var n = 0; n < e; ++n) {
        ...
        q = k.length;
        x = 0;
        for (z = p; z < p + q; ++z) (k[x] = mb(c, z, !0)), ++x;
        for (q = p = 0; q < d; ++q) p += k[q] * Math.pow(2, -q - 1);
        f[n] =
          0 === p && 0 === m
            ? 0
            : y * (1 + p) * Math.pow(2, 1 + m - Math.pow(2, a - 1));
      }
      return f;
    }
    function nb() {
    ...
    function Nb(a) {
      if (ea !== ba.pause) {
        var c = ea === ba.play ? H.Aa : I.Ec;
        bb = setTimeout(zb.bind(null, a), c);
      }
    }
    function ob() {
    ...
    function zb() {
      if (ea !== ba.pause) {
        ...
        if (!t.kb)
          a: {
            if (t.jb) {
              if (!t.element.needsUpdate) break a;
              t.W.Xd(t.element.arrayBuffer);
              t.element.needsUpdate = !1;
            } else {
              var a = t.element.currentTime,
                c = a - t.Oa;
              0 > c && (t.Oa = a);
              if (1e3 * c < I.Zd) break a;
              t.Oa += c;
              t.W.refresh();
            }
            u.set("s48");
        ...
        if (E.L.length > P.F) E.L.splice(0, E.L.length - P.F);
        else for (; E.L.length < P.F; ) E.L.push(0);
        if (1 !== E.i)
          if (ma.every(pb)) {
            for (var d = (a = c = 0); d < ma.length; ++d)
              ma[d].detected > c && ((c = ma[d].detected), (a = 0));
            for (c = 0; c < P.F; ++c) E.L[c] = a;
          } else {
            a = E.dc;
            c = 0;
            for (d = !1; c < P.F; ++c) {
        ...
        for (a = 0; a < P.F; ++a)
          (E.$ = E.L[a]),
            (E.qb = (0.5 + E.$) / E.i),
            (E.ac = E.L.lastIndexOf(E.$) === a),
            u.set("s49"),
            H.ga && u.B("u36", ma[E.$].rz),
            1 !== E.i && u.B("u35", E.qb),
            V.Ga.J(),
            t.ba.b(0),
            U.Qa.b(1),
        ...
        P.timestamp = a;
        -1 !== W.nDetectsPerLoop
          ? (P.F = W.nDetectsPerLoop)
          : ((a = I.Ta),
            (P.hc = P.ob / P.ra),
            (P.ic = P.hc * a + P.ic * (1 - a)),
            (P.kc = 1e3 / P.ra),
            (P.ia = P.kc * I.Ta + P.ia * (1 - I.Ta)),
            P.ia > I.ea[1]
              ? ((a = I.za[1]),
                1 < E.i &&
                  (++a, (c = ma.filter(Ob).length), (a *= Math.max(1, c))),
                (P.F = Math.min(P.F + 1, a)),
                (P.ia = (I.ea[0] + I.ea[1]) / 2))
              : P.ia < I.ea[0] &&
                ((P.F = Math.max(P.F - 1, I.za[0])),
                (P.ia = (I.ea[0] + I.ea[1]) / 2)));
        ra.G();
        ...
        for (a = 0; a < E.i; ++a)
          if (-1 !== E.L.indexOf(a)) {
            ...
            var k = qb[e],
              l = 2 * e;
            c.Da = Ca(1, l, 3, 0, 1);
            d.detected = pa.P(d.detected, c.Da, I.Bc);
            if (c.Da < I.nb) H.ga && (d.rz = 0);
            else {
              var n = U.ya;
              c.x = Ca(0, l, 1, -1, 1);
              c.y = Ca(0, l, 2, -1, 1);
              c.T = Ca(0, l, 3, 0, 1);
              c.tb = Ca(1, l, 0, -n[0], n[0]);
              c.ub = Ca(1, l, 1, -n[1], n[1]);
              c.va = Ca(1, l, 2, -n[2], n[2]);
              for (n = 0; n < U.R; ++n) c.Ob[n] = U.ta[n](Ca(2, l, n, 0, 1));
              f.Za = c.x - d.x;
              f.$a = c.y - d.y;
              f.Ya = c.T - d.s;
              f.Va = c.tb - d.rx;
              ...
              f =
                ...
                cb.Ia(sa.qualityFactorRange[0], sa.qualityFactorRange[1], c.Da);
              e = k[++rb[e] % k.length] = f;
              for (l = 0; l < k.length; ++l) e = Math.min(e, k[l]);
              e = Math.max(0.5, e);
              f = Math.min(e, f);
              k = pa.P(sa.alphaRange[1], sa.alphaRange[0], Math.pow(f, I.Dc));
              d.x = pa.P(d.x, c.x, k);
              d.y = pa.P(d.y, c.y, k);
              d.s = pa.P(d.s, c.T, k);
              d.rx = pa.P(d.rx, c.tb, k);
              d.ry = pa.P(d.ry, c.ub, k);
              d.rz = H.ga ? d.rz + k * c.va : pa.P(d.rz, c.va, k);
              k = Math.max(k, I.Cc);
              for (e = 0; e < U.R; ++e)
                d.expressions[e] = pa.P(d.expressions[e], c.Ob[e], k);
              ++c.La;
            }
          }
        ra.Wd();
        ...
        b.disable(b.BLEND);
        ea === ba.play && (Qa = window.requestAnimationFrame(Nb));
      }
    }
    function Pb() {
      function a(d) {
        for (var e = [], f = 0; f < E.i; ++f)
          e.push(JSON.parse(JSON.stringify(d)));
        return e;
      }
      t.ba = R.instance({
        isPot: !1,
      ...
      V.Ga = R.instance({ isPot: !0, isFloat: !1, width: za.Tb() });
      var c = {
        width: 3,
        height: E.i,
        isFloat: !0,
    ...
    function sb() {
      u.K("s49", [
        ...
        { type: "2f", name: "u34", value: V.v },
        { type: "1f", name: "u35", value: 0.5 },
        { type: "1f", name: "u36", value: 0 },
      ]);
      u.K("s50", [
        { type: "1i", name: "u37", value: 0 },
        { type: "1i", name: "u33", value: 1 },
        { type: "1f", name: "u40", value: I.Ud },
        { type: "1f", name: "u41", value: I.yc },
      ...
      var a = [{ type: "1i", name: "u37", value: 0 }];
      u.K("s51", a);
      u.K("s52", a);
      u.K("s47", [
        { type: "1i", name: "u33", value: 0 },
        { type: "1f", name: "u46", value: V.v[0] },
        { type: "2f", name: "u45", value: [0, 0.5 / E.i] },
      ]);
    }
    function tb() {
      var a = za.Tb(),
      ...
      Pa = W.minScale * c;
      Ya = W.maxScale * c;
      Za = (1 - 2 * W.borderWidth) / W.nStepsX;
      $a = (1 - 2 * W.borderHeight) / W.nStepsY;
      ab = (Ya - Pa) / W.nStepsScale;
      ib = W.borderWidth;
      jb = W.borderHeight;
      kb = 1 - W.borderWidth;
      lb = 1 - W.borderHeight;
    ...
    function Rb(a) {
      if (H.la) Cb("string" === typeof H.la ? JSON.parse(H.la) : H.la, a);
      else {
        var c = H.zb;
    ...
    function Cb(a, c) {
      ...
      U.R || (U.R = I.jc);
      if (!U.ta) for (U.ta = [], d = 0; d < U.R; ++d) U.ta.push(I.dd);
      c(a);
    }
    function Sb() {
      if (
    ...
    function Tb() {
      return Ta.some(function (a, c) {
        if (c === E.$) return !1;
        c = Ta[E.$];
        if (c.La > a.La || 3 > a.La || Eb(c.x, c.T, a.x, a.T) < I.ec * c.T)
          return !1;
        var d = V.M / V.O;
        return Eb(c.y, c.T * d, a.y, a.T * d) > I.ec * c.T * d;
      });
    }
    function Ub() {
      var a = E.$;
      ...
      Oa > Ya &&
        ((Ma += Za),
        (Oa = Pa),
        Ma > kb && ((Ma = ib), (Na += $a), Na > lb && (Na = jb)));
      Wa = Ma + 0.5 * (Math.random() - 0.5) * Za;
      Xa = Na + 0.5 * (Math.random() - 0.5) * $a;
      ub = Oa + 0.5 * (Math.random() - 0.5) * ab;
    }
    function Fb() {
      t.W && t.W.remove();
      t.jb = t.element.isFakeVideo ? !0 : !1;
      t.W = R.instance(
        Object.assign(
          { isPot: !1, isFloat: !1 },
          t.jb
            ? {
                isFlipY: !1,
                array: t.element.arrayBuffer,
                width: t.element.videoWidth,
                height: t.element.videoHeight,
                isKeepArray: !0,
              }
            : { D: t.element }
        )
    ...
    function Ha() {
      ...
      a > c ? (t.C[1] *= c / a) : (t.C[0] *= a / c);
      u.K("s50", [{ name: "u44", type: "1f", value: c }]);
      t.m[0] = 0;
      t.m[1] = 0;
      t.m[2] = 0;
      t.m[3] = 0;
      switch (ha.rotate) {
        ...
        case 90:
          ...
          break;
        case -90:
          (t.m[1] = -t.C[0]), (t.m[2] = t.C[1]);
      }
      ha.flipX && ((t.m[0] *= -1), (t.m[2] *= -1));
    }
    function vb() {
      var a = t.element.videoWidth,
        c = t.element.videoHeight,
        d = t.v[0] !== a || t.v[1] !== c;
      d && ((t.v[0] = a), (t.v[1] = c));
      return d;
    }
    ...
    function Gb(a, c, d) {
      ...
      ha.deviceId && (t.qa.deviceId = ha.deviceId);
      S.get(
        t.element ? t.element : S.nd(),
        function (e) {
          c && c(e);
          d(e);
        },
    ...
    var pa = {
          ...
          G = {
            ...
            wb: function () {
              ...
              l.na.forEach(function (w, A) {
                A = l.ma[A];
                b.vertexAttribPointer(w, A, b.FLOAT, !1, l.yb, g);
                g += 4 * A;
              });
            },
            Mb: function () {
        ...
        function c() {
          ...
          if (/(Mac)/i.test(navigator.platform)) {
            ...
            (m = navigator.userAgent)
              ? ((m =
                  m.match(/Mac OS X (\d+)_(\d+)/) ||
                  m.match(/Mac OS X (\d+).(\d+)/)),
                (m =
                  !m || 3 > m.length
                    ? !1
        ...
        var d = null,
          ...
          y = {
            ...
            Me: function () {
              ...
              for (
                var m = y.jd(),
                  q = f.createImageData(e.width, e.height),
                  x = e.width,
                  z = e.height,
                  T = q.data,
                  M = 0;
            ...
            Ke: function (m) {
              !e &&
                ...
                ((e = document.createElement("canvas")),
                (f = e.getContext("2d")));
              var q = m ? e : document.createElement("canvas");
              q.width = d.width;
              q.height = d.height;
              (m ? f : q.getContext("2d")).drawImage(d, 0, 0);
              return q;
            },
            o: function (m) {
              m.Vc && !m.Ua
                ? (d = document.getElementById(m.Vc))
                : m.Ua && (d = m.Ua);
              ...
              if (!b) {
                ...
                navigator &&
                  ...
                  (q.antialias = !1);
                c() || (b = d.getContext("webgl2", q));
                b
                  ? (l = !0)
                  : ((b = d.getContext("webgl", q)) ||
                      (b = d.getContext("experimental-webgl", q)),
                    (l = !1));
              }
              if (!b) return a("WebGL is not enabled");
              (k = b.getExtension("WEBGL_lose_context")) &&
                m.lc &&
                ((p = m.lc), d.addEventListener("webglcontextlost", p, !1));
              if (!Z.o()) return a("Not enough capabilities");
              if (!Z.Kc() && l)
                return a(
                  "Your configuration cannot process color buffer float"
                );
              ...
              b.GENERATE_MIPMAP_HINT &&
                b.hint(b.GENERATE_MIPMAP_HINT, b.FASTEST);
            ...
            h: function () {
              ...
              k &&
                p &&
                (d.removeEventListener("webglcontextlost", p, !1), (p = null));
              n = f = e = d = null;
            },
          };
        return y;
      ...
      Ia = (function () {
        var a = "undefined" === typeof u ? null : u;
        return {
          Od: function (c) {
            a !== c && (a && a.ka(), (a = c));
          },
      ...
      ka = (function () {
        var a = null,
          ...
          n = {
            ...
            instance: function (p) {
              var y = d++,
                m = p.aa ? p.aa.length : 0,
                q = "undefined" === typeof p.mode ? b.STATIC_DRAW : p.mode,
                x = b.createBuffer();
              b.bindBuffer(b.ARRAY_BUFFER, x);
              b.bufferData(
                b.ARRAY_BUFFER,
                p.wc instanceof Float32Array ? p.wc : new Float32Array(p.wc),
                q
              );
              e = y;
              var z = null,
              ...
              if (p.aa) {
                ...
                b.bufferData(
                  b.ELEMENT_ARRAY_BUFFER,
                  p.aa instanceof F ? p.aa : new F(p.aa),
                  q
                );
                f = y;
              }
          ...
          l = {
            o: function () {
              if (!e) {
                ...
                var n = Z.u();
                c =
                  n && b.DRAW_FRAMEBUFFER ? b.DRAW_FRAMEBUFFER : b.FRAMEBUFFER;
                d =
                  n && b.READ_FRAMEBUFFER ? b.READ_FRAMEBUFFER : b.FRAMEBUFFER;
                e = !0;
              }
            },
            Oe: function () {
            ...
            instance: function (n) {
              ...
              var F = {
                qc: function () {
                  z || ((q = b.createFramebuffer()), (z = !0), (M = k.Pb++));
                },
                zc: function () {
                  F.qc();
                  F.l();
                ...
                bind: function (D, G) {
                  M !== k.w && (b.bindFramebuffer(c, q), (k.w = M));
                  p && p.l();
                ...
                rtt: function (D) {
                  p = D;
                  k.w !== M && (b.bindFramebuffer(b.FRAMEBUFFER, q), (k.w = M));
                  D.l();
                },
                G: function () {
      ...
      Fa = (function () {
        ...
        function c(r) {
          ...
          return 103 > N
            ? C
            : 142 < N
            ? C | 31744 | ((255 == N ? 0 : 1) && r & 8388607)
            : 113 > N
            ? ((h |= 2048), C | ((h >> (114 - N)) + ((h >> (113 - N)) & 1)))
            : (C = (C | ((N - 112) << 10) | (h >> 1)) + (h & 1));
        }
        function d(r) {
          var C = new Uint16Array(r.length);
          r.forEach(function (h, N) {
            C[N] = c(h);
          });
          return C;
        }
        function e() {
          ...
          var r = k(d([1, 1, 1, 1]));
          return null === r ? !0 : (oa.fb = r);
        }
        function f() {
          if (null !== oa.gb) return oa.gb;
          var r = k(new Uint8Array([255, 255, 255, 255]));
          return null === r ? !0 : (oa.gb = r);
        }
        function k(r) {
          if (!Ia.lb() || !M) return null;
          var C = null;
          try {
            var h = b.getError();
            C = B.instance({ isFloat: !1, H: !0, array: r, width: 1 });
            h = b.getError();
          ...
          B = {
            o: function () {
              if (!M) {
                ...
                Y && JEContext.gf() && n.push(b.TEXTURE8, b.TEXTURE9);
                y = [-1, -1, -1, -1, -1, -1, -1, -1];
                x = [b.UNSIGNED_BYTE, b.FLOAT, b.FLOAT];
                if (!m) {
                  for (var r = new Float32Array(16384), C = 0; 16384 > C; ++C)
                    r[C] = 2 * Math.random() - 1;
                  m = {
                    random: B.instance({
                      isFloat: !0,
            ...
            instance: function (r) {
              function C() {
                ...
                h.isAnisotropicFiltering &&
                  ...
                  b.texParameterf(
                    b.TEXTURE_2D,
                    JEContext.Ne().TEXTURE_MAX_ANISOTROPY_EXT,
                    JESETTINGS.ae
                  );
                b.texParameteri(
                  b.TEXTURE_2D,
                ...
                if ((h.H && !h.isFloat) || (h.isFloat && h.isMipmap && Ua.vd()))
                  (v = b.RGBA16F) && (ia = v), (ja = Z.Fa());
                h.mb && (eb = h.mb);
                h.isSrgb && 4 === h.Ka && (fa = JEContext.Xe());
                ...
                gb = !0;
                h.Z && X && (h.Z(X), (h.Z = null));
              }
              var h = Object.assign({}, D, r),
                N = p++;
              ...
              h.H = h.H || h.isFloat;
              h.H && (qa = 1);
              h.rd || Z.u() || !h.isFloat || !na || Z.Fb() || (h.isFloat = !1);
              h.isFloat && (qa = 2);
              h.isAnisotropicFiltering &&
                Y &&
                !JEContext.af() &&
              ...
              var ta = b.createTexture(),
                ...
                va = h.isFlipY,
                Ja =
                  h.H && h.isMipmap && "undefined" !== typeof Ua && !Ua.Mc()
                    ? !0
                    : !1,
                Ra = null,
                eb = -1,
                fb = !1,
                La = { bc: !1, Eb: null, Qb: null };
              ...
              var X = {
                ...
                Ic: function (v, L) {
                  Ja
                    ? (v || (v = X.Ub()), X.Sa(L), a(Ra[v]), (y[L] = -1))
                    : X.b(L);
                },
                Ub: function () {
                  -1 === eb && (eb = Math.log(J) / Math.log(2));
                  return eb;
                },
                fd: function (v) {
                  if (Ja) {
                ...
                Jb: function () {
                  ...
                  xb = new Uint8Array(4 * v);
                  Va = new Float32Array(xb.buffer);
                  hb = !0;
                },
                pc: function () {
                  hb || X.Jb();
                  b.readPixels(0, 0, J, 4 * K, b.RGBA, b.UNSIGNED_BYTE, xb);
                ...
                Gd: function () {
                  La.bc ||
                    ((La.Eb = new Uint8Array(J * K * 4)),
                    (La.Qb = new Float32Array(La.buffer)),
                    (La.bc = !0));
                  b.readPixels(0, 0, J, K, b.RGBA, b.UNSIGNED_BYTE, La.Eb);
                  return La.Qb;
                },
                Kb: function (v) {
                  aa.G();
                  ...
                  if (v)
                    b.viewport(0, 0, J, K),
                      u.vb("u8", 0.25, 0.25, 0.25, 0.25),
                      ka.g(!1, !0);
                  else
                    for (v = 0; 4 > v; ++v)
                      b.viewport(0, K * v, J, K),
                        u.vb("u8", A[v]),
                        ka.g(!1, 0 === v);
                },
                Xd: function (v) {
                  ...
                  L
                    ? (Hb ||
                        ...
                        (xa.height = K),
                        (Sa = xa.getContext("2d")),
                        (wb = Sa.createImageData(J, K)),
                        (Hb = !0)),
                      wb.data.set(v),
                      Sa.putImageData(wb, 0, 0),
              ...
              if (h.url)
                ...
                h.array
                  ...
                  : C();
              X.We = X.A;
              h.Z && gb && (h.Z(X), (h.Z = null));
              F.push(X);
              return X;
            },
            G: function (r) {
              r !== l && (b.activeTexture(n[r]), (l = r));
              y[r] = -1;
              a(null);
            },
            ee: function (r) {
            ...
            reset: function () {
              for (var r = 0; r < n.length; ++r) y[r] = -1;
              l = -1;
            },
            qf: function () {
              l = -1;
            ...
            Vd: function () {
              for (var r = 0; r < n.length; ++r) B.G(r);
            },
            Rb: function () {
              m && (m.random.remove(), m.vc.remove());
            },
            Bf: function (r, C) {
      ...
      Ua = (function () {
        ...
        function c(z) {
          return Z.Fb() && a(m, b.FLOAT, new Float32Array(p), z)
            ? ((k = f.Ab), !0)
            : !1;
        }
        function d(z) {
          return Z.Lc()
            ? a(q, Z.Fa(), new Uint16Array(p), z) ||
              a(q, b.FLOAT, new Float32Array(p), z)
              ? ((k = f.Ra), !0)
              : !1
            : !1;
        }
      ...
      Kb = (function () {
        return {
          instance: function (a) {
            ...
            a.mask &&
              ((d = !0),
              I && void 0 !== I.Fc && (a.mask = I.Fc + a.mask),
            ...
            switch (p) {
              ...
              case "inputLightRegulation":
                n = m ? m : "s28";
                f = Xb.instance({ Yb: y, nc: a.size, fc: a.nBlurPass, ud: !1 });
                e = !0;
                break;
              case "direct":
              case "none":
            ...
            l && u.K(n, [{ name: "u26", type: "1f", value: a.tilt }]);
            d && (n += "Mask");
            var q = R.instance({ isFloat: !1, isPot: !1, width: a.size }),
              x = {
                A: function () {
                  return y;
                },
      ...
      Lb = (function () {
        return {
          instance: function (a) {
            "undefined" === typeof a.disableNormalize &&
              (a.disableNormalize = !1);
            var c = {
                input: null,
                fa: null,
                ib: null,
              ...
              q = a.dynPelu ? Wb.instance(a.dynPelu) : !1,
              x = q ? !0 : !1,
              z = { isEnabled: !1 };
            a.td
              ? ((a.sparsity =
            ...
            if (a.maxPooling) {
              ...
              F = !0;
              D /= a.maxPooling.size;
              c.rb = R.instance({ isFloat: !0, isPot: !1, width: D });
            }
            var g = void 0 !== a.Cd && a.Cd ? !0 : !1,
              w = null,
              A = null,
              Y = null;
            if (g) {
              w = "s43" + a.index.toString();
              u.Xb("s43", w, [((a.normalization.n - 1) / 2).toFixed(1)]);
              u.K(w, [
                { type: "1i", name: "u1", value: 0 },
            ...
            var oa = {
              ...
              Md: function () {
                switch (a.connectivityUp) {
                  case "direct":
                    ca = Yb.instance(a.connectivity);
                    break;
                  case "square":
                    ca = Zb.instance(a.connectivity);
                    break;
                  case "squareFast":
                    ca = $b.instance(a.connectivity, a.activation);
                    break;
                  case "full":
                    ca = ac.instance(a.connectivity);
                    break;
                  case "conv":
                    (p = a.kernelsNumber),
              ...
              I: function (B) {
                ...
                ca.ja
                  ? (c.input.J(),
                    ...
                    c.input.fd(la),
                    c.ib.J(),
                    m ? u.set("s0") : (u.set("s27"), u.B("u25", M), c.fa.b(1)),
                    c.input.Ic(la, 0),
                    Q.g(!1, !1),
                    u.set(T),
                    g ? A.l() : c.S.l(),
              ...
              Uc: function (B) {
                B && "undefined" !== typeof B.mc && ((k = B.mc), (l = B.Dd));
                c.S = R.instance({
                  isFloat: !0,
                  isPot: !0,
                  isMipmap: !1,
    ...
    var Yb = (function () {
            ...
            return {
              ...
              I: function (e) {
                if (e.isEnabled) {
                  ...
                  for (f = 0; f < k; ++f) e.layers[f].Hc(4 + f);
                } else u.set("s23");
                u.B("u16", a.toLayerSize);
                d.b(1);
                Q.g(!1, !1);
              },
            };
      ...
      $b = (function () {
        return {
          instance: function (a, c) {
            ...
            var m =
              "s45" +
              [d.toString(), e.toString(), f.toString(), k.toString(), c].join(
                "_"
              );
            u.cd(m) ||
              ((a = Vb.gd(c, "gl_FragColor", "gl_FragColor")),
              (e = [
                { type: "1f", name: "u16", value: e },
                { type: "1f", name: "u30", value: k },
              ]),
              n && e.push({ type: "1f", name: "u24", value: d }),
              (d = [(n ? l : f).toFixed(1), a]),
      ...
      S = {
        nd: function () {
          return S.Ib() ? document.createElement("video") : !1;
        },
        sa: function (a, c) {
          a[c] = !0;
        ...
        Tc: function (a) {
          function c(q) {
            return [
              ...
              return Math.abs(x - q) - Math.abs(z - q);
            });
          }
          function d(q) {
            var x = S.Rc(a);
          ...
          if (a.video.width && a.video.height) {
            if (a.video.width.ideal && a.video.height.ideal) {
              var f = c(a.video.width.ideal).slice(0, 3),
                ...
                l = {},
                n = 0;
              for (l.Y = void 0; n < f.length; l = { Y: l.Y }, ++n) {
                l.Y = f[n];
                var p = {},
                  y = 0;
                for (p.X = void 0; y < k.length; p = { X: p.X }, ++y)
                  if (
                    ((p.X = k[y]),
                    l.Y !== a.video.width.ideal || p.X !== a.video.height.ideal)
                  ) {
                    var m = Math.max(l.Y, p.X) / Math.min(l.Y, p.X);
                    m < 4 / 3 - 0.1 ||
                      m > 16 / 9 + 0.1 ||
                      d(
                        (function (q, x) {
                          return function (z) {
                            z.video.width.ideal = q.Y;
                            z.video.height.ideal = x.X;
                            return z;
                          };
                        })(l, p)
                      );
          ...
          return navigator.mediaDevices
            ...
            .then(function (l) {
                ...
                setTimeout(function () {
                  if (a.currentTime) {
                    ...
                    if (0 === p || 0 === y) f("VIDEO_NULLSIZE");
                      ...
                      p = { Nc: null, Rd: null, zd: null };
                      try {
                        var m = l.getVideoTracks()[0];
                        m &&
                          ((p.zd = m),
                          (p.Nc = m.getCapabilities()),
                          (p.Rd = m.getSettings()));
                      } catch (q) {}
                      S.Oc()
              ...
              "undefined" !== typeof a.srcObject
                ? (a.srcObject = l)
                : ((a.src = window.URL.createObjectURL(l)),
                  (a.videoStream = l));
              S.Ja(a);
              a.addEventListener(
                "loadeddata",
        ...
        get: function (a, c, d, e) {
          ...
          if (!S.Ib()) return d && d("MEDIASTREAMAPI_NOTFOUND"), !1;
          if (e && e.video) {
            if (S.Gb()) {
              var f = S.hd();
      ...
      ba = { pb: -3, xd: -1, error: -2, play: 1, pause: 2 },
      ea = ba.pb,
      t = null,
      cc = {
        kb: !1,
      ...
      W = null,
      sa = null;
    var ub = (Oa = Xa = Wa = Na = Ma = Ya = Pa = lb = kb = jb = ib = ab = $a = Za = 0);
    var V = null,
      ec = { M: 0, O: 0, v: [0, 0], Ga: null },
      U = { Qa: null, buffer: null, ca: null, ya: null, R: I.jc, ta: null },
      Ta = null,
      ma = null,
      bb = null,
      Qa = null,
      E = { i: 1, $: 0, L: null, ac: !1, dc: 0, qb: 0 },
      P = {
        ra: 0,
        timestamp: 0,
        hc: 0,
      ...
      Jb = {
        ...
        init: function (a) {
          ...
          "undefined" !== typeof a.NNCpath && (H.zb = a.NNCpath);
          ...
          "undefined" !== typeof a.followZRot &&
            (H.ga = a.followZRot ? !0 : !1);
          if (E.i > I.Ad) return Da("MAXFACES_TOOHIGH"), !1;
          ...
          for (var d = 0; d < E.i; ++d)
            qb.push(new Float32Array(I.Bd)), rb.push(0);
          W = Object.create(I.Hd);
          a.scanSettings &&
            (Object.assign(W, a.scanSettings),
            -1 !== W.nDetectsPerLoop &&
              ((P.F = W.nDetectsPerLoop), (P.ob = W.nDetectsPerLoop)));
          ...
          a.videoSettings && a.videoSettings.videoElement
            ? db(a.videoSettings.videoElement, c)
            : (a.videoSettings && Object.assign(ha, a.videoSettings),
              Gb(a.onWebcamAsk, a.onWebcamGet, function (f) {
                db(f, c);
              }));
          Rb(function (f) {
            if (!Sb()) return !1;
            za = new yb({});
            za.Jd(f.layers);
            za.Ld({ mc: "gpuRawAvg", Dd: Ub });
            u.Ac([
              {
                id: "s48",
                name: "_",
                da:
                  "attribute vec2 a0;uniform mat2 u32;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=vec2(.5,.5)+u32*a0*vec2(1.,-1.);}",
                Ba: ["a0"],
                ma: [2],
                a:
                  "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
              ...
              },
              {
                ...
                a:
                  "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
                da:
                  "attribute vec2 a0;uniform sampler2D u33;uniform vec2 u34;uniform float u35,u36;varying vec2 vv0;void main(){vec4 a=texture2D(u33,vec2(.17,u35));vec2 d=a.gb,f=a.a*u34;float b=cos(u36),c=sin(u36);vec2 g=mat2(b,c,-c,b)*a0;vv0=d+g*.5*f,gl_Position=vec4(a0,0.,1.);}",
                Ba: ["a0"],
                ma: [2],
                c: ["u1", "u33", "u34", "u35", "u36"],
                precision: "lowp",
              },
              {
                id: "s50",
              ...
              },
              {
                ...
                da:
                  "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
                a:
                  "uniform sampler2D u37;const vec4 e=vec4(.25,.25,.25,.25);const vec3 f=vec3(.5,.5,.5);void main(){float a=dot(e,texture2D(u37,vec2(.125,.875))),b=dot(e,texture2D(u37,vec2(.375,.875))),c=dot(e,texture2D(u37,vec2(.625,.875))),d=dot(e,texture2D(u37,vec2(.625,.625)));vec3 g=vec3(a,b,c)*.5+f;gl_FragColor=vec4(g,d);}",
                c: ["u37"],
              },
              {
                id: "s52",
                ...
                da:
                  "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
                a:
                  "uniform sampler2D u37;const vec4 e=vec4(.25,.25,.25,.25);void main(){float a=dot(e,texture2D(u37,vec2(.375,.375))),b=dot(e,texture2D(u37,vec2(.625,.375))),c=dot(e,texture2D(u37,vec2(.875,.375))),d=dot(e,texture2D(u37,vec2(.125,.125)));gl_FragColor=vec4(a,b,c,d);}",
                c: ["u37"],
              },
              {
                id: "s47",
        ...
        toggle_pause: function (a, c) {
          if (!nb()) return Promise.reject();
          c = c ? S.uc(t.element, !a, t.qa) : Promise.resolve();
          a ? Ab() : ob();
          return c;
        },
        ...
        set_videoOrientation: function (a, c) {
          nb() && ((ha.flipX = c), (ha.rotate = a), Ha(), Ga());
        },
        update_videoElement: function (a, c) {
          db(a ? a : t.element, function () {
            Fb();
            Ha();
            Ga();
            c && c();
